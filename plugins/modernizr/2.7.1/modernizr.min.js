(window.Modernizr = (function (aw, av, au) {
  ...
  function N(g, f, j) {
    ...
    return R(f, "string") || R(f, "undefined")
      ? P(h, f)
      : ((h = (g + " " + af.join(i + " ") + i).split(" ")), O(h, f, j));
  }
  function M() {
    (ar.input = (function (f) {
      for (var b = 0, a = f.length; a > b; b++) {
        ab[f[b]] = !!(f[b] in al);
      }
      return (
        ab.list &&
          (ab.list = !(
            !av.createElement("datalist") || !aw.HTMLDataListElement
          )),
        ab
      );
    })(
      ...
      (ar.inputtypes = (function (b) {
        for (var k, j, g, l = 0, c = b.length; c > l; l++) {
          al.setAttribute("type", (j = b[l])),
            (k = "text" !== al.type),
            k &&
              ((al.value = ak),
              (al.style.cssText = "position:absolute;visibility:hidden;"),
              /^range$/.test(j) && al.style.WebkitAppearance !== au
                ? (ap.appendChild(al),
                  (g = av.defaultView),
                  (k =
                    g.getComputedStyle &&
                    "textfield" !==
                      g.getComputedStyle(al, null).WebkitAppearance &&
                    0 !== al.offsetHeight),
                  ap.removeChild(al))
                : /^(search|tel)$/.test(j) ||
                  (k = /^(url|email)$/.test(j)
                    ? al.checkValidity && al.checkValidity() === !1
                    : al.value != ak)),
            (ac[b[l]] = !!k);
        }
        return ac;
  ...
  var Y,
    ...
    ae = { svg: "http://www.w3.org/2000/svg" },
    ad = {},
    ac = {},
    ab = {},
    aa = [],
    ...
    X = function (v, u, t, s) {
      ...
      return (
        ...
        g
          ...
          : (b.parentNode.removeChild(b), (ap.style.overflow = o)),
        !!q
      );
    },
    W = (function () {
      function c(h, g) {
        ...
        return (
          a ||
            (g.setAttribute || (g = av.createElement("div")),
            g.setAttribute &&
              g.removeAttribute &&
              (g.setAttribute(h, ""),
              (a = R(g[h], "function")),
  ...
  (U =
        ...
        var h = Z.call(arguments, 1),
          g = function () {
            if (this instanceof g) {
              ...
              var b = new c(),
                a = e.apply(b, h.concat(Z.call(arguments)));
              return Object(a) === a ? a : b;
            }
            return e.apply(f, h.concat(Z.call(arguments)));
          };
        return g;
      }),
    (ad.flexbox = function () {
    ...
    (ad.canvastext = function () {
      return !(
        !ar.canvas ||
        !R(av.createElement("canvas").getContext("2d").fillText, "function")
      );
    }),
    (ad.webgl = function () {
    ...
    (ad.touch = function () {
      ...
      return (
        "ontouchstart" in aw ||
        (aw.DocumentTouch && av instanceof DocumentTouch)
          ? (a = !0)
          : X(
              [
                "@media (",
                ai.join("touch-enabled),("),
                ao,
                ")",
    ...
    (ad.hashchange = function () {
      return (
        W("hashchange", aw) && (av.documentMode === au || av.documentMode > 7)
      );
    }),
    (ad.history = function () {
    ...
    (ad.rgba = function () {
      return (
        T("background-color:rgba(150,255,150,.5)"),
    ...
    (ad.cssgradients = function () {
      ...
      return (
        T(
          (e + "-webkit- ".split(" ").join(d + e) + ai.join(f + e)).slice(
            0,
            -e.length
          )
        ),
    ...
    (ad.sessionstorage = function () {
      try {
        return (
          sessionStorage.setItem(ao, ao), sessionStorage.removeItem(ao), !0
        );
      } catch (b) {
        return !1;
      }
    ...
    (ad.svg = function () {
      return (
        !!av.createElementNS &&
        !!av.createElementNS(ae.svg, "svg").createSVGRect
      );
    }),
    ...
    (ad.smil = function () {
      return (
        !!av.createElementNS &&
        /SVGAnimate/.test(aj.call(av.createElementNS(ae.svg, "animate")))
      );
    }),
    (ad.svgclippaths = function () {
      return (
        !!av.createElementNS &&
        /SVGClipPath/.test(aj.call(av.createElementNS(ae.svg, "clipPath")))
      );
    });
  for (var L in ad) {
    U(ad, L) &&
  ...
  return (
      ...
      function x(b, h, f) {
        ...
        return (
          (e = f.cache[b]
            ? f.cache[b].cloneNode()
            : G.test(b)
            ? (f.cache[b] = f.createElem(b)).cloneNode()
            : f.createElem(b)),
          !e.canHaveChildren || H.test(b) || e.tagUrn
            ? e
            : f.frag.appendChild(e)
        );
      }
      function w(b, l) {
        if ((b || (b = K), B)) {
            ...
            "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" +
              z()
                ...
                .replace(/[\w\-]+/g, function (b) {
                  return (
                    c.createElem(b), c.frag.createElement(b), 'c("' + b + '")'
                  );
                }) +
              ");return n}"
          )(t, c.frag));
    ...
    (ar.testAllProps = N),
    (ar.testStyles = X),
    (ar.prefixed = function (e, d, f) {
      return d ? N(e, d, f) : N(e, "pfx");
    }),
    (ap.className =
      ap.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") +
      (aq ? " js " + aa.join(" ") : "")),
    ar
  );
})(this, this.document)),
  (function (ad, ac, ab) {
        ...
        b
          ? b.t
            ? R(function () {
                ("c" == b.t
                  ? M.injectCss
                  : M.injectJs)(b.s, 0, b.a, b.x, b.e, 1);
              }, 0)
            : (b(), W())
          : (L = 0);
    }
    function V(w, v, t, s, q, p, n) {
      ...
      var n = n || M.errorTimeout,
        h = ac.createElement(w),
        g = 0,
        b = 0,
        x = { t: t, s: v, e: q, a: p, x: n };
      1 === D[v] && ((b = 1), (D[v] = [])),
        ...
        "img" != w &&
          (b || 2 === D[v]
            ? (I.insertBefore(h, J ? null : Q), R(m, n))
            : D[v].push(h));
    }
    function U(g, e, j, i, h) {
      return (
        ...
        Z(g)
          ...
          : (N.splice(this.i++, 0, g), 1 == N.length && W()),
        this
      );
    }
    function T() {
    ...
    (M = function (e) {
        ...
        o.url.split(".").pop().split("?").shift(),
          o.bypass ||
            (s &&
              (s = aa(s)
                ? s
                : s[b] || s[q] || s[b.split("/").pop().split("?")[0]]),
            o.instead
              ? o.instead(b, s, r, q, p)
              : (D[o.url] ? (o.noexec = !0) : (D[o.url] = 1),
                r.load(
                  o.url,
                  o.forceCSS ||
                    (!o.forceJS &&
      ...
      if (Z(e)) {
        ...
        if (F(e)) {
          for (k = 0; k < e.length; k++) {
            (f = e[k]),
              Z(f) ? n(f, 0, d, 0) : F(f) ? M(f) : Object(f) === f && m(f, d);
          }
        } else {
          Object(e) === e && m(e, d);
        }
      ...
      (M.addPrefix = function (d, c) {
        C[d] = c;
      }),
      (M.addFilter = function (b) {
        E.push(b);
      }),
      ...
      null == ac.readyState &&
        ...
        ac.addEventListener(
          "DOMContentLoaded",
          (O = function () {
            ac.removeEventListener("DOMContentLoaded", O, 0),
      ...
      (ad.yepnope.injectJs = function (r, q, p, n, m, h) {
        ...
        (q = h ? W : q || Y),
          (g.onreadystatechange = g.onload =
            function () {
              !f &&
                X(g.readyState) &&
                ((f = 1), q(), (g.onload = g.onreadystatechange = null));
            }),
          R(function () {
            f || ((f = 1), q(1));
          }, n),
